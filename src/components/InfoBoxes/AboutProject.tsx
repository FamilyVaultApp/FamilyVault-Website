      ...
      <div className="infobox-border">
        <div className="infobox container-xxl bd-gutter rounded-2">
          ...
          <div className="infobox-content about-project">
            Family Vault to mobilna aplikacja stworzona z myślą o rodzinach.
            ...
            - i wiele więcej. <br />
            Dzięki zastosowaniu szyfrowania End-to-End (E2E) opartego na
            bibliotece PrivMX by Simplito, użytkownicy mogą mieć pewność, że ich
            dane są w pełni chronione. Prosta i intuicyjna obsługa sprawia, że
            aplikacja jest przyjazna zarówno dla dzieci, jak i dorosłych.
          </div>
          <br />
        </div>
      </div>
